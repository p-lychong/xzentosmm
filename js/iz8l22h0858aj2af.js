 ...
 * ======================================================================== */
 $(document).ready(function(){
    $("#searchService").on("keyup", function() {
      ...
      $(".servie-data-panel").filter(function() {
